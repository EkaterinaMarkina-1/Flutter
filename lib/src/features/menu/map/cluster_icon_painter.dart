...
class ClusterIconPainter {
  ...
  /// Метод, который формирует фигуру кластера и преобразует ее в байтовый формат
...
/// Метод, который отрисовывает текст, отображающий количество маркеров в кластере
